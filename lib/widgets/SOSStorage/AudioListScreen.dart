...
class _AudioListFirstScreenState extends State<AudioListFirstScreen> {
  ...
  Future<Map<String, List<String>>> fetchAudioList() async {
    ...
    try {
      ...
      print('Error fetching audio list: $error');
      return {};
    }
  }
                                    ...
                                    return FutureBuilder<Map<String, String>>(
                                      ...
                                      builder: (context, snapshot) {
                                        if (snapshot.connectionState == ConnectionState.waiting) {
                                          ...
                                          String? audioUrl = snapshot.data![audioName];
                                          return DetailedScreen(audioName, audioUrl);
                                        }
                                      },
                                    );
                                  },
...
class DetailedScreen extends StatefulWidget {
  ...
  const DetailedScreen(this.title, this.url);
...
class _DetailedScreenState extends State<DetailedScreen> {
  ...
  void play() async {
    if (widget.url != null) {
      ...
      Fluttertoast.showToast(msg: "Audio URL not found");
    }
  }
